...
const Healthcare = () => {
    ...
    const contractAddress = "0xe5e058c4111a3803718a773d9c0416377885737a";
    ...
    return(
        <div className='container'>
            <h1 className = "title">Blockchain-Enabled Decentralised EHR System</h1>
        ...
        <div className="form-section">
            <h2>Authorize Medical History Provider</h2>
